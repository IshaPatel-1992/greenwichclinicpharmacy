...
export default function TransferPrescription() {
  return (
    <section id="transfer-prescription" className="py-20 bg-gray-50 text-gray-800">
      <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-start">
        
        {/* Left: Transfer Prescription Form */}
        <div className="bg-white shadow-lg rounded-lg p-8">
          <h2 className="text-3xl font-bold text-teal-700 mb-6">Transfer Your Prescription</h2>
          <p className="mb-6 text-teal-900 font-medium">
            Please fill out the form below and our pharmacists will take care of the rest.
          </p>
          <form className="grid gap-5">
            ...
            <input
              type="tel"
              placeholder="Current Pharmacy Phone Number"
              className="p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-teal-500"
            />
            <textarea
...
// This code defines a React component for a "Transfer Prescription" page.
// It includes a form for users to fill out their information to transfer their prescription,